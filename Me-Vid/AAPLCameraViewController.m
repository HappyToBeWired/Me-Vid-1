...
@interface AAPLCameraViewController () <AVCaptureFileOutputRecordingDelegate, AAPLCameraDelegate>
...
- (void)viewDidLoad
{
	...
	dispatch_async( self.sessionQueue, ^{
		...
		AVCaptureDevice *videoDevice = [AAPLCameraViewController deviceWithMediaType:AVMediaTypeVideo preferringPosition:AVCaptureDevicePositionFront];
		...
		if ( [self.session canAddInput:videoDeviceInput] ) {
			...
			dispatch_async( dispatch_get_main_queue(), ^{
				...
				AVCaptureVideoPreviewLayer *_previewLayer = (AVCaptureVideoPreviewLayer *)self._previewView.layer;
...
- (void)viewWillTransitionToSize:(CGSize)size withTransitionCoordinator:(id<UIViewControllerTransitionCoordinator>)coordinator
{
	...
	if ( UIDeviceOrientationIsPortrait( deviceOrientation ) || UIDeviceOrientationIsLandscape( deviceOrientation ) ) {
		AVCaptureVideoPreviewLayer *_previewLayer = (AVCaptureVideoPreviewLayer *)self._previewView.layer;
		_previewLayer.connection.videoOrientation = (AVCaptureVideoOrientation)deviceOrientation;
	}
}
